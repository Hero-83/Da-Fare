...
6. Si E="pendiente" color de fuente normal                  [☑️]
7. Si E="atrasado"  color de fuente rojo                    [☑️]
8. Si E="Completado" color de fuente normal, fondo          [☑️]
ligeramente oscuro                  
9. Si E="Completado con retraso" color de fuente rojo,      [☑️]
